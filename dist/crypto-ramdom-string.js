...
const generateRandomBytes = (byteLength, type, length) => crypto_1.default.randomBytes(byteLength).toString(type).slice(0, length);
...
exports.default = cryptoRandomString;
//# sourceMappingURL=crypto-ramdom-string.js.map